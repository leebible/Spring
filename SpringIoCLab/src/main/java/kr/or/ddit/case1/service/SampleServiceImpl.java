...
//	3. Strategy pattern : 전략을 주입받아 사용하는 구조. 전략의 주입자와 주입방법이 필수 ==> DI Container
//	4. DI Container 사용 : 의존객체와 객체들 간의 의존관계 형성을 대신 해주는 대상.
	...
	public void setDao(SampleDAO dao) {
		this.dao = dao;
		log.info("{} 를 기본 생성자로 생성, {}, setter로 주입받음 ", this.getClass().getSimpleName(), dao.getClass().getSimpleName());
	}
	...
	public List<SampleVO> readSampleList(){ //김치찌개
