<%@page import="kr.or.ddit.member.controller.MemberInsertController"%>
	...
	<table class="table table-bordered">
		<tr>
			...
			<td><form:input type="text" path="memId" required="true"
					class="form-control" /> <form:errors path="memId"
		...
		<tr>
			...
			<td><form:input type="text" path="memName" required="true"
					class="form-control" /> <form:errors path="memName"
					cssClass="text-danger" element="span" /></td>
		</tr>
		<tr>
			<th>앞자리 주민번호</th>
			<td><form:input type="text" path="memRegno1"
					class="form-control" /> <form:errors path="memRegno1"
					cssClass="text-danger" element="span" /></td>
		</tr>
		<tr>
			<th>뒷자리 주민번호</th>
			<td><form:input type="text" path="memRegno2"
					class="form-control" /> <form:errors path="memRegno2"
					cssClass="text-danger" element="span" /></td>
		</tr>
		<tr>
			<th>생년월일</th>
		...
		<tr>
			...
			<td><form:input type="text" path="memZip" required="true"
					class="form-control" /> <form:errors path="memZip"
					cssClass="text-danger" element="span" /></td>
		</tr>
		<tr>
			<th>기본주소</th>
			<td><form:input type="text" path="memAdd1" required="true"
					class="form-control" /> <form:errors path="memAdd1"
					cssClass="text-danger" element="span" /></td>
		</tr>
		<tr>
			<th>상세주소</th>
			<td><form:input type="text" path="memAdd2" required="true"
					class="form-control" /> <form:errors path="memAdd2"
					cssClass="text-danger" element="span" /></td>
		</tr>
		<tr>
			<th>집번호</th>
		...
		<tr>
			...
			<td><form:input type="text" path="memMail" required="true"
					class="form-control" /> <form:errors path="memMail"
					cssClass="text-danger" element="span" /></td>
		</tr>
		<tr>
			<th>직업</th>
		...
		<tr>
			...
			<td><form:input type="text" path="memMemorial"
					class="form-control" /> <form:errors path="memMemorial"
					cssClass="text-danger" element="span" /></td>
		</tr>
		<tr>
			<th>기념일자</th>
			<td><form:input type="date" path="memMemorialday"
					class="form-control" /> <form:errors path="memMemorialday"
					cssClass="text-danger" element="span" /></td>
		</tr>
		<tr>
			<th>마일리지</th>
			<td><form:input type="number" path="memMileage"
					class="form-control" /> <form:errors path="memMileage"
					cssClass="text-danger" element="span" /></td>
		</tr>
		<tr>
			<th>상태코드</th>
			<td><form:input type="text" path="memDelete"
					class="form-control" /> <form:errors path="memDelete"
					cssClass="text-danger" element="span" /></td>
		</tr>
		<tr>
			<td colspan="2">
