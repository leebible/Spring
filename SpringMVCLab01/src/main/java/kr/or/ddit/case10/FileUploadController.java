...
public class FileUploadController {
	...
	public String uploadProcess4(
		...
		for(UploadFileVO fileVO : voList) {
			...
			log.info("{} 업로드 완료, DB에 저장할 메타데이터: {}", fileVO.getFileName(), fileVO);
		}
	...
	@PostMapping("upload2")
	public String uploadProcess2(@RequestParam String uploader, @RequestParam int count,
	...
	@PostMapping("upload1")
	public String uploadProcess1(@RequestParam String uploader, @RequestParam int count,
